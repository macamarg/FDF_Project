...
/*   Updated: 2024/10/01 14:53:26 by macamarg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	while (ft_is_newline(current_line) == -1)
	{
		...
		current_line = ft_strjoin_gnl(current_line, read_content[fd]);
...
int main()
{
	...
	fd = open("/home/macamarg/common_core/FdF_project/2024-08-14/42.fdf", O_RDONLY | O_CREAT);
	if (fd < 0)
	{
